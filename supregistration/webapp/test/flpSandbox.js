		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comhvsupregistration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhvsupregistration-display": {
								"semanticObject": "comhvsupregistration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hv.supregistration",
									"url": sap.ui.require.toUrl("com/hv/supregistration")
								}
							}
						}
					}
